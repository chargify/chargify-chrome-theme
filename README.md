Just a Chargify-green theme for Chrome.  This is handy for differentiating different windows when you use multiple Chrome "personas" in order to avoid weirdness from having multiple Google accounts.
